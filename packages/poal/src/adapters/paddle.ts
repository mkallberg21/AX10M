 ...
 * Retain). There is no third-party retry API — Lift CANNOT drive a charge here.
 ...
 *
 * Strategic note: Paddle Retain competes head-on with Lift; this adapter exists so
 * Lift can still *measure* recovery on Paddle accounts and win on attribution.
 */
